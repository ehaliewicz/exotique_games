...
REM ============================================================
"%GCC%" -c %CFLAGS% -std=c2x -Ofast -march=native ^
...
REM ============================================================
REM 
"%GCC%" -c %CFLAGS% -std=c99 -O3 -ggdb -ffast-math -march=native -fno-strict-aliasing -nostdlib -nodefaultlibs -nolibc -ffreestanding ^
    -I ".." ^
    ^
    -D ARCH=%ARCH% ^
    "%GAME%.c"
